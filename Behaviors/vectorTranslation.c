...
vector_2d convert2rf(float x_offset, float y_offset, float theta, uint32_t ir_distance)
{
    vector_2d sensor_vec;

    sensor_vec.x = cos(theta) * ir_distance + x_offset;
    sensor_vec.y = sin(theta) * ir_distance + y_offset;
